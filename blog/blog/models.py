...
class Blog(TimeStampModel):
    ...
    thumbnail = models.ImageField('썸네일', null=True, blank=True,
                                  upload_to='blog/%y-%m-%d/thumbnail') # blank: form에서 입력할 때 빈 값을 허용하는지 유무
    # xxxx/x/xx
    # blog/xxxx/x/xx/이미지파일.jpg
    # ImageField, FieldField와 같지만  이미지만 업로드 하게 되어있다.
    # varchar => 경로만 저장을 함
    ...
    # makemirations: 기본값이 안정해져 있으면 선택지를 준다. (1.디폴트값, 2.종료)
    ...
    def save(self, *args, **kwargs):
        ...
        thumbnail_name = image_path.stem # /blog/2026/3/24/database.png => database
        thumbnail_extension = image_path.suffix.lower() # /blog/2026/3/24/database.png => .png
